            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="fit-center">Status</td>
                ...
                <tbody>
                    @forelse ($jobs as $job)
                        <tr>
                            ...
                            <td class="fit-center">{{$job->ref}}</td>
                            <td class="fit-center">
                            ...
                            <td class="fit-center">{{diffInDays(now(), $job->created_at)}}</td>
                            <td class="fit-center">
                                <a href="{{$job->id}}" class="btn btn-sm btn-warning"><i class="bi bi-eye"></i> View</a>
                            </td>
                        </tr>
                    @empty
